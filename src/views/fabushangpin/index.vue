...
　　　　　　  </van-col>
      ...
      <van-cell-group>
      <van-field v-model="username" placeholder="请输入商品名称" label-align="left" label="商品名称：" clearable required></van-field>
      
      <van-field class="tess" v-model="message"  type="textarea" placeholder="请输入商品内容"  rows="1" autosize style="height:200px;" />
    </van-cell-group>
